                        ...
                        <div className="cart-list">
                          <div className="product-widget">
                            <div className="product-img">
                              <img src={require("./img/product01.png")} />
                            </div>
                          ...
                          <div className="product-widget">
                            <div className="product-img">
                              <img src={require("./img/product02.png")} />
                            </div>
                            <div className="product-body">
                              <h3 className="product-name">
            ...
            <div className="row">
              <div id="aside" className="col-md-3">
                ...
                <div className="aside">
                  ...
                  <div className="product-widget">
                    <div className="product-img">
                      <img src={require("./img/product03.png")} />
                    </div>
                    <div className="product-body">
                      <p className="product-category">Category</p>
                      <h3 className="product-name">
              ...
              <div id="store" className="col-md-9">
                ...
                <div className="row">
                  ...
                  <div className="col-md-4 col-xs-6">
                    <div className="product">
                      <div className="product-img">
                        <img src={require("./img/product04.png")} />
                      </div>
                      <div className="product-body">
                        <p className="product-category">Category</p>
                        <h3 className="product-name">
                  ...
                  <div className="col-md-4 col-xs-6">
                    <div className="product">
                      <div className="product-img">
                        <img src={require("./img/product05.png")} />
                      </div>
                      <div className="product-body">
                        <p className="product-category">Category</p>
                        <h3 className="product-name">
                  ...
                  <div className="col-md-4 col-xs-6">
                    <div className="product">
                      <div className="product-img">
                        <img src={require("./img/product06.png")} />
                      </div>
                      <div className="product-body">
                        <p className="product-category">Category</p>
                        <h3 className="product-name">
                  ...
                  <div className="col-md-4 col-xs-6">
                    <div className="product">
                      <div className="product-img">
                        <img src={require("./img/product07.png")} />
                      </div>
                      <div className="product-body">
                        <p className="product-category">Category</p>
                        <h3 className="product-name">
                  ...
                  <div className="col-md-4 col-xs-6">
                    <div className="product">
                      <div className="product-img">
                        <img src={require("./img/product08.png")} />
                      </div>
                      <div className="product-body">
                        <p className="product-category">Category</p>
                        <h3 className="product-name">
                  ...
                  <div className="col-md-4 col-xs-6">
                    <div className="product">
                      <div className="product-img">
                        <img src={require("./img/product09.png")} />
                      </div>
                      <div className="product-body">
                        <p className="product-category">Category</p>
                        <h3 className="product-name">
